...
Revision ID: 464b8bf3c674
Revises: 
Create Date: 2018-07-28 08:45:08.885794
...
def upgrade():
    ...
    sa.Column('lastlogin_date', sa.DateTime(), nullable=True),
    sa.Column('lastlogin_date_cache', sa.DateTime(), nullable=True),
